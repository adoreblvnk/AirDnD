  ...
  run: [
    {
      ...
      params: {
        ...
        env: {
          ...
          PINOKIO_SHARE_VAR: '{{env.PINOKIO_SHARE_VAR || "__airdnd_sharing_disabled__"}}',
          AIRDND_RATELIMIT_OPENAI_PER_MIN: '{{env.AIRDND_RATELIMIT_OPENAI_PER_MIN || ""}}',
          AIRDND_RATELIMIT_GOOGLE_PER_MIN: '{{env.AIRDND_RATELIMIT_GOOGLE_PER_MIN || ""}}',
        },
