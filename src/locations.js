 ...
 * in airdndActions.js) so downstream context/screenshot policy treats it as a globe view,
...
export async function searchAndFlyTo(viewer, query, options = {}) {
  ...
  if (
    ...
    // of Hawaii", voice `viewMode: 'overview'` — airdndActions.js). That is an explicit
