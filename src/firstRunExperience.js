...
export const FIRST_RUN_STORAGE_KEY = 'airdnd:first-run-mission:v1';
/** Per-session dismissal. Written by every close path; scoped to sessionStorage. */
export const FIRST_RUN_SESSION_KEY = 'airdnd:first-run-mission-session:v1';
 ...
 * Layer enablement IS durable in this app (`airdnd:layer-state:v2`, written by
 ...
 *   NOT TOUCHED           detection allocation (`airdnd:detection-allocation:v1`),
