...
export const CAMERA_PRESETS = {
  ...
  singapore: {
    destination: Cesium.Cartesian3.fromDegrees(103.820, 1.155, 17500),
    orientation: {
      heading: Cesium.Math.toRadians(0),
...
/**
 * Set camera to Singapore on load with a cinematic fly-in.
 */
export function flyToSingapore(viewer) {
  viewer.camera.setView({
    destination: Cesium.Cartesian3.fromDegrees(103.820, 1.120, 32000),
    orientation: {
      heading: Cesium.Math.toRadians(0),
