...
| File | Description |
| :--- | :--- |
| **`IDEA.md`** | High-level summary, plain English concept, and 2-minute hackathon demo script. |
| **`SUBMISSION_DRAFT.md`** | Comprehensive submission dossier, rubric breakdown, technical specifications, and pitch responses. |
| **`PROBLEM_STATEMENTS.md`** | Filtered briefs, constraints, and judging criteria for Track 03 (Interceptors) and Track 04 (One Picture, Many Eyes). |
| **`AirDnD_WILDCARD_ANALOGIES.md`** | Deep dive on novel distributed systems mechanisms: EscrowCore, SeedBank, and GhostCover. |
| **`resources/`** | Official SDTH 2026 organizer problem briefs for Tracks 00, 03, and 04. |
