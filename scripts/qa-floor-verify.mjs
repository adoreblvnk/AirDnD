...
await page.waitForFunction(() => window.__airDnD?.dataManager && window.__airDnD?.viewer, { timeout: 150000 });
await sleep(2000);
...
await page.evaluate(async () => { await window.__airDnD.dataManager.toggle('flights'); });
